...
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).name = 'Aprendizaje';
...
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'Control-Apzj';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).onset = [32
                                                         96
                                                         160
                                                         224];
...
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).name = 'Control-Recuerdo';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).onset = [288
                                                         352
                                                         416
                                                         480];
...
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).name = 'Recuerdo';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).onset = [256
                                                         384
                                                         320
                                                         448];
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).duration = 8;
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Aprzj vs Control (Learn > BL)';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.convec = [1 -1 0 0];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Recobro vs Control(R) (Recall > BL)';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.convec = [0 0 -1 1];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Recobro vs Aprendizaje (Recall > Learn)';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.convec = [-1 0 0 1];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = '(Aprzj + Recobro) - REST (Learn+Recall > BL)';
