...
flirt -applyisoxfm 2 -init $work_dir/surf2diff.mat -interp nearestneighbour -in $work_dir/seed1.nii.gz -ref $work_dir/fa -out $work_dir/seed2.nii.gz
...
echo "[$SUBJ-17/30] Selecting voxels below 150 on seed..."
...
track -inputmodel dt -header $in_dir/$dti_image_file -seedfile $work_dir/seed5.nii.gz -anisthresh 0.3 -curvethresh 90 -inputfile $work_dir/$difusion_tensor_image > $work_dir/$tractography_image
