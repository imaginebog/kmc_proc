...
matlabbatch{1}.spm.tools.rwls.fmri_rwls_spec.sess.cond.name = 'coordinacion';
matlabbatch{1}.spm.tools.rwls.fmri_rwls_spec.sess.cond.onset = [10
                                                                30
                                                                50
                                                                70];
matlabbatch{1}.spm.tools.rwls.fmri_rwls_spec.sess.cond.duration = 10;
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Coordinacion(active)';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.convec = 1;
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Coordinacion (zonas desactivadas)';
